window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/root/codes/dsh-web-auth-gateway/src/client/gateway-settings.module.css.mjs
		const css = ".J1uy_a_card{gap:18px;padding:4px 0;display:grid}.J1uy_a_row{justify-content:space-between;align-items:center;gap:24px;display:flex}.J1uy_a_row p,.J1uy_a_field small{color:var(--dsw-alias-label-tertiary);margin:4px 0 0;font-size:12px;display:block}.J1uy_a_row input{width:18px;height:18px}.J1uy_a_field{gap:6px;display:grid}.J1uy_a_field>span{font-weight:600}.J1uy_a_field input{box-sizing:border-box;width:180px;max-width:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major);border:1px solid var(--dsw-alias-border-l3);border-radius:6px;padding:8px 10px}.J1uy_a_actions{justify-content:flex-end;gap:8px;display:flex}.J1uy_a_actions button{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-ghost-active-fill);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:7px 14px}.J1uy_a_actions button:disabled{opacity:.5}.J1uy_a_actions .J1uy_a_primary{color:var(--dsw-alias-label-primary-foreground);background:var(--dsw-alias-button-primary-fill);border-color:#0000}.J1uy_a_error{color:var(--dsw-alias-state-error-primary)}";
		...
		var gateway_settings_module_css_default = {
			"actions": "J1uy_a_actions",
			"card": "J1uy_a_card",
			"error": "J1uy_a_error",
			"field": "J1uy_a_field",
			"primary": "J1uy_a_primary",
			"row": "J1uy_a_row"
		};
		//#endregion
