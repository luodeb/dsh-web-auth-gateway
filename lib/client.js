window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\workspace\com\noon\TP\agents\dsh-web-auth-gateway\src\client\gateway-settings.module.css.mjs
		const css = "._5J_uUW_card{gap:18px;padding:4px 0;display:grid}._5J_uUW_row{justify-content:space-between;align-items:center;gap:24px;display:flex}._5J_uUW_row p,._5J_uUW_field small{color:var(--dsw-alias-label-tertiary);margin:4px 0 0;font-size:12px;display:block}._5J_uUW_row input{width:18px;height:18px}._5J_uUW_field{gap:6px;display:grid}._5J_uUW_field>span{font-weight:600}._5J_uUW_field input{box-sizing:border-box;width:180px;max-width:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major);border:1px solid var(--dsw-alias-border-l3);border-radius:6px;padding:8px 10px}._5J_uUW_actions{justify-content:flex-end;gap:8px;display:flex}._5J_uUW_actions button{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-ghost-active-fill);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:7px 14px}._5J_uUW_actions button:disabled{opacity:.5}._5J_uUW_actions ._5J_uUW_primary{color:var(--dsw-alias-label-primary-foreground);background:var(--dsw-alias-button-primary-fill);border-color:#0000}._5J_uUW_error{color:var(--dsw-alias-state-error-primary)}";
		const tagId = "dsh-web-auth-gateway/gateway-settings.module.css";
		...
		var gateway_settings_module_css_default = {
			"actions": "_5J_uUW_actions",
			"card": "_5J_uUW_card",
			"error": "_5J_uUW_error",
			"field": "_5J_uUW_field",
			"primary": "_5J_uUW_primary",
			"row": "_5J_uUW_row"
		};
		//#endregion
